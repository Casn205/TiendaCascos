...
const NewsLetter = () => {
  return (
    <section className="max_padd_cotainer py-12 xl:py-28 bg-white">
        <div className="mx-auto xl:w-[80%] flexCenter flex-col gap-y-8 w-full max-w-[666px">
            ...
            <h4 className="uppercase bold-18">Suscribete to our newsletter and stay updated</h4>
            <div className="flexBetween rounded-full ring-1 ring-slate-900/5 hover:ring-slate-900/15 bg-primary w-full max-w-[588px]">
                <input type="email" placeholder="Your email addres" className="w-full bg-transparent ml-7 border-none outline-none regular-16" />
